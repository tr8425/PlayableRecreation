...
| 11 | 결과 화면의 폰 해제 명세, 기록 탭·긴 대화 잘림 | 09-10 추가 관찰 | **수정됨 · 재검사 대기** (2026-09-10) — 판이 끝나면 10초 붙잡고, 그동안 창을 보거나 만지면 다시 10초, 아니면 스스로 놓는다. 기록 창 탭은 줄을 늘리고, 긴 대화는 잘라 쓰고 툴팁에 통째로 남긴다. 대화 빈도·사망 처리 시간은 **QA 가 옳고 내 기대값이 틀렸다** — MTB 6600틱은 게임 시간 1시간 20분(둘이 굴릴 때)이지 1분이 아니다. 명세 §16-1 과 체크리스트를 고쳤다 |
