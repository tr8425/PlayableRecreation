...
| 7 | **리얼리티 모드** (설계 검토중, 2026-09-09) — 상대를 고른 뒤 두 폰을 판 앞에 붙잡아 두고, 대화·사교 다툼·상대의 죽음·방문객까지 이야기로 잇는다 | ferny 09-09 파생 | **명세 있음: `DESIGN_RealityMode.md`** (2026-09-09). 1단계가 곧 6번이고, 1단계만으로도 낼 수 있게 잘라 두었다 |
