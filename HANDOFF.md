...
- **리얼리티 모드** — 상대를 식민자 중에서 고르고 둘을 판 앞에 세운다.
  명세가 `DESIGN_RealityMode.md` 에 있다 (2026-09-09, ferny 지적에서 나왔다).
  1단계(고르기 + 이름 + 제안 난이도)만으로도 낼 수 있게 잘라 두었고, 폰을 붙잡는
  2단계부터가 진짜 비용이다. 만들기 전에 §16 의 가정 다섯을 인게임에서 확인할 것
