...
규모: C# 119 파일 · 21,300 줄. 테스트 284 개. 배포본 61 파일 · 646 KB.
...
- **몰입 모드 2칸 인게임 확인** — 네 단계가 전부 들어갔으나 한 번도 돌려 보지
  않았다. 명세 §16 의 가정 여섯 중 3·5번은 코드로 답이 나왔고 나머지는 아직
  모른다. 특히 **D6 — 붙잡아 두면 대화가 정말 뜨는가.** 아니면 §7.2 의 대화
  띠가 늘 비어 있게 되고, 그러면 §18.1 의 내보내기가 선택이 아니라 필수가 된다.
  그 다음이 §18 의 세 얹기(내보내기 · 모으기 · 관전과 응원)인데, 셋 다 아직 결정 전이다
